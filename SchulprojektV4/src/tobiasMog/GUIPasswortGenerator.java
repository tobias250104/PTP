...
//	-> Alle Dateipfade in GUIPasswortGenerator und PasswortGenerator müssen angepasst werden!
//	-> Bei allen dateipfaden sollte das Laufwerk geändert werden
//-> Die core-3.2.1 muss mit eingebunden werden aufgrund der QR-Codes
//-----------------------------------------------------------------------------------------------\
...
public class GUIPasswortGenerator extends JFrame implements ActionListener
{
 ...
 private PasswortGenerator generator;
 ...
 public GUIPasswortGenerator(){
 	...
 	Bild1.setIcon(new ImageIcon("E:\\Projekt\\abdruck.png"));
 	Bild1.setBounds(400, 150, 200, 200);
 	this.add(Bild1);
 	
 	JLabel Bild2 = new JLabel("");
 	Bild2.setIcon(new ImageIcon("E:\\Projekt\\ueberschrift.png"));
 	Bild2.setBounds(360, -10, 400, 200);
 	this.add(Bild2);
 	
 	JLabel Bild3 = new JLabel("");
 	Bild3.setIcon(new ImageIcon("E:\\Projekt\\schloss.png"));
 ...
 public void actionPerformed (ActionEvent ae)
  ...
  // Button abfragen (Passwortstärke - 16)
     else if(ae.getSource() == this.button_16)
 	{
     	...
     	PasswortGenerator pw16 = new PasswortGenerator(16);
     	...
     	QR.setIcon(new ImageIcon("E:\\Projekt\\QRcode.png"));
  ...
  // Button abfragen (Passwortstärke - 32)
     else if(ae.getSource() == this.button_32)
 	{
     	...
     	PasswortGenerator pw32 = new PasswortGenerator(32);
  ...
  // Button abfragen (Passwortstärke - 64)
     else if(ae.getSource() == this.button_64)
 	{
     	...
     	PasswortGenerator pw64 = new PasswortGenerator(64);
  ...
  // Button abfragen (Passwortstärke - 128)
     else if(ae.getSource() == this.button_128)
 	{
     	...
     	PasswortGenerator pw128 = new PasswortGenerator(128);
